...
def example_data():
    ...
    data = {
        ...
        'Accessible': {
            'labels': ['RDA-F1-01M', 'RDA-F1-01D', 'RDA-F1-02M', 'RDA-F1-02D', 'RDA-F2-01M', 'RDA-F3-01M',
                       'RDA-F4-01M', 'dos'],
            'data': [1, 2, 3, 4, 0, 2, 3, 4]
        },
        'Interoperable': {
            'labels': ['RDA-F1-01M', 'RDA-F1-01D', 'RDA-F1-02M', 'RDA-F1-02D', 'RDA-F2-01M', 'RDA-F3-01M',
                       'RDA-F4-01M', 'dos', 'dos'],
            'data': [1, 2, 3, 4, 0, 2, 3, 3, 1]
        },
        'Reusable': {
            'labels': ['RDA-F1-01M', 'RDA-F1-01D', 'RDA-F1-02M', 'RDA-F1-02D', 'RDA-F2-01M', 'RDA-F3-01M',
                       'RDA-F4-01M', 'dos', 'dos', 'dos'],
            'data': [1, 2, 3, 4, 0, 2, 3, 1, 1, 2]
        }
    }
...
if __name__ == '__main__':
    ...
    for k, v in data.items():
        axs[i].set_rgrids([1, 2, 3, 4])
        axs[i].set_title(k, weight='bold', size='medium', position=(0.5, 1.1), horizontalalignment='center', verticalalignment='center')
        axs[i].plot(theta[k], v['data'], color='#48BADD')
        axs[i].fill(theta[k], v['data'], facecolor='#48BADD', alpha=0.25, label='_nolegend_')
        #axs[i].set_varlabels(v['labels'])
        i += 1
